...
})({"64D5d":[function(require,module,exports) {
"use strict";
...
new (0, _swiperDefault.default)(".slider", {
    ...
    pagination: {
        el: ".pagination",
        clickable: true,
        renderBullet: (index, className)=>`<button type="button" class="pagination__button ${className}"></button>`
    }
});
...
function loopCreate() {
    ...
    for(let i1 = 0; i1 < appendSlides.length; i1 += 1)$selector.append((0, _domJsDefault.default)(appendSlides[i1].cloneNode(true)).addClass(params.slideDuplicateClass));
    for(let i2 = prependSlides.length - 1; i2 >= 0; i2 -= 1)$selector.prepend((0, _domJsDefault.default)(prependSlides[i2].cloneNode(true)).addClass(params.slideDuplicateClass));
}
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["64D5d","aMYz0"], "aMYz0", "parcelRequired7c6")
